...
* [Azure 函数应用](https://docs.microsoft.com/azure/azure-functions/functions-create-function-app-portal)订阅。
...
1. [创建 Azure 函数应用](https://docs.microsoft.com/azure/azure-functions/functions-create-function-app-portal)，用于[验证来自合作伙伴中心的回调事件](https://docs.microsoft.com/partner-center/develop/partner-center-webhooks#how-to-authenticate-the-callback)。
    ...
    6. 创建 RSA 加密提供程序。
    7. [验证签名](https://docs.microsoft.com/partner-center/develop/partner-center-webhooks#example-for-signature-validation)是否与使用指定哈希算法（例如 SHA256）签名的内容匹配。
...
5. [注册以接收 Webhook 事件](https://docs.microsoft.com/partner-center/develop/partner-center-webhooks#register-to-receive-events)（创建或更新引荐时的）。 请使用以下正文格式：
